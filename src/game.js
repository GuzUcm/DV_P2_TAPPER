...
//Capa 1 - Jugador, cervezas, clintes y deadzones
  ...
  //Spawner(n, delay, numClientes, tiempo_entre_clientes, tipo_cliente) "n" = numero de barra donde se pondra el cliente
...
var startGame = function() {
  ...
  Game.setBoard(3,new TitleScreen("Tapper", "Pulsa espacio para jugar", playGame));
};
...
//------------------------------------------------------------Cerveza (Inicialmente llena y al colisionar pasa a estar vacia)---------------------//
...
//------------------------------------------------------------Spawner - Crea clientes en una determinada barra del bar------------//
